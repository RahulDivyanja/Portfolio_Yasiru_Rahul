  ...
  return (
    ...
    >
      <div className="h-full w-full text-white duration-400 group-hover:scale-105">
        ...
        >
          <span className="absolute top-2 left-2 w-fit rounded-full border border-gray-700 bg-black px-4 py-2 text-xs shadow-md backdrop-blur-md dark:border-none">{type}</span>
        ...
        <Image className="h-full w-full bg-gray-200 dark:bg-gray-800" src={src} alt={alt} priority decoding="async" />
      </div>
    </div>
  )
}
