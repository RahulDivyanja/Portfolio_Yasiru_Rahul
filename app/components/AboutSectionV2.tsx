...
export const AboutSectionV2 = ({ className = "" }: { className?: string }) => {
  return (
    <section id="about" className={clsx("border-y border-gray-200 bg-white dark:bg-transparent dark:border-white/5", className)}>
      <div className="inside-container relative z-2">
        ...
        <div className="flex flex-col-reverse gap-12 md:flex-row md:gap-16">
          ...
          <Typography as="article" size="lg" className="[flex:1.5_0_0px] space-y-8 text-slate-500 dark:text-slate-400">
            ...
            <p>
              <strong className="font-semibold text-slate-900 dark:text-slate-200">I ship v1s in weeks and iterate in days</strong>. Specialized in {DATA.skills.slice(0, 3).join(", ")}.
            </p>
